...
> **[Inter-VLAN Routing and ACL Configuration for Secure Data Flow](#)**
> * Designed and simulated a robust enterprise-level network architecture using **Cisco Packet Tracer**.
> * Implemented strict access control mechanisms to ensure secure data transmission across organizational departments.

> **[Personal Portfolio Deployment](#)**
> * Developed a responsive portfolio leveraging web technologies to showcase technical expertise.
> * Successfully managed source code and deployed directly via **GitHub Pages**.

> **[Custom Python Utilities](#)**
> * Engineered custom software solutions, including an independent browser tool ("Anik Browser") and media applications, focusing on algorithmic efficiency.
